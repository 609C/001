...
public class TLClassStore {
	...
	public TLClassStore () {
		...
		classStore.put(TLRPC.TL_alertMediaEmpty.constructor, TLRPC.TL_alertMediaEmpty.class);
		classStore.put(TLRPC.TL_alertMedia.constructor, TLRPC.TL_alertMedia.class);
		classStore.put(TLRPC.TL_messageMediaAlert.constructor, TLRPC.TL_messageMediaAlert.class);
		...
		//xueqiang add for desizilize

		classStore.put(TLRPC.TL_UserCompany.constructor, TLRPC.TL_UserCompany.class);
		classStore.put(TLRPC.TL_Company.constructor, TLRPC.TL_Company.class);
		classStore.put(TLRPC.TL_DepartMent.constructor, TLRPC.TL_DepartMent.class);
		classStore.put(TLRPC.TL_MeetingInfo.constructor, TLRPC.TL_MeetingInfo.class);
		classStore.put(TLRPC.TL_ChannalInfo.constructor, TLRPC.TL_ChannalInfo.class);
		classStore.put(TLRPC.TL_PendingCompanyInfo.constructor, TLRPC.TL_PendingCompanyInfo.class);
		classStore.put(TLRPC.TL_messages_call.constructor, TLRPC.TL_messages_call.class);
		//hz
		classStore.put(TLRPC.TL_Affiche.constructor, TLRPC.TL_Affiche.class);
		classStore.put(TLRPC.TL_PSTNMeeting.constructor, TLRPC.TL_PSTNMeeting.class);
		//qxm add 反序列化
		classStore.put(TLRPC.TL_DirectPlayBackList.constructor, TLRPC.TL_DirectPlayBackList.class);
	...
	public TLObject TLdeserialize(AbsSerializedData stream, int constructor, TLObject request) {
		...
		if (objClass != null) {
			...
			FileLog.e("emm", String.format("unknown class %x", constructor));
			return null;
