    ...
    public ByteBufferDesc getFreeBuffer(int size) {
        ...
        if (size <= 128) {
            ...
            if (buffer == null) {
                ...
                FileLog.e("emm", "create new 128 buffer");
            }
            ...
            if (buffer == null) {
                ...
                FileLog.e("emm", "create new 1024 buffer");
            }
            ...
            if (buffer == null) {
                ...
                FileLog.e("emm", "create new 4096 buffer");
            }
            ...
            if (buffer == null) {
                ...
                FileLog.e("emm", "create new 16384 buffer");
            }
        } else if (size <= 40000) {
            ...
            if (buffer == null) {
                ...
                FileLog.e("emm", "create new 40000 buffer");
            }
        } else {
