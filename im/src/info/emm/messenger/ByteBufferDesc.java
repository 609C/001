...
public class ByteBufferDesc extends AbsSerializedData {
    ...
    public void writeInt32(int x) {
        try {
            ...
            FileLog.e("emm", "write int32 error");
        }
    }
    ...
    public void writeInt64(long x) {
        try {
            ...
            FileLog.e("emm", "write int64 error");
        }
    }
    ...
    public void writeByte(byte b) {
        try {
            ...
            FileLog.e("emm", "write byte error");
        }
    }
    ...
    public void writeString(String s) {
        try {
            ...
            FileLog.e("emm", "write string error");
        }
    }
    ...
    public void writeByteArray(byte[] b, int offset, int count) {
        try {
            ...
            FileLog.e("emm", "write byte array error");
        }
    }
    ...
    public void writeDouble(double d) {
        try {
            ...
            FileLog.e("emm", "write double error");
        }
    }
    ...
    public int readInt32(boolean[] error) {
        try {
            ...
            FileLog.e("emm", "read int32 error");
        }
        return 0;
    }
    ...
    public long readInt64(boolean[] error) {
        try {
            ...
            FileLog.e("emm", "read int64 error");
        }
        return 0;
    }
    ...
    public String readString() {
        try {
            ...
            FileLog.e("emm", "read string error");
        }
        return null;
    }
    ...
    public byte[] readByteArray() {
        try {
            ...
            FileLog.e("emm", "read byte array error");
        }
        return null;
    }
    ...
    public double readDouble() {
        try {
            ...
            FileLog.e("emm", "read double error");
        }
        return 0;
    }
